define([
    ...
    return Backbone.View.extend({
        ...
        render: function(){
            ...
            var type = this.model.get('display_type');
            if (type=='one page'){
                ...
                this.states_one_page_view = new StatesOnePageView({el: '#steps', model: this.model})
            ...
            if (type=='one state per page'){
                ...
                this.states_one_state_per_page_view = new StatesOneStatePerPageView({el: '#steps', model: this.model})
