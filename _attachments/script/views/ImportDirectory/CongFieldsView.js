define([
    ...
    return Backbone.View.extend({
        ...
        display_button: function(event) {
            ...
            if (window.app.dir.get('fields')[selected_field] !== undefined){
                $('#details_regex').val(window.app.dir.get('fields')[selected_field].regex);
            }
            ...
            function create_regular_expression(){
                $('#cong_details_fields_selector *').mouseup(function(event){
                    ...
                    // Store an object in the directory.fields object under the selected_field (field name) 
                    //  as its property name
                    ...
                    // TODO: Is the regex method syntax correct below?
                    var patt = new RegExp(field_regex)
                    var result = patt.test(s.concat())
                    ...
                    // TODO: Make store_directory() available in this scope.  It's currently in download_congs.js:45
                    store_directory();
