define([
    ...
    return Backbone.View.extend({
        ...
        render: function(){
            ...
            // TODO: - Try to be able to guess which unit of distance (Mi or KM) they prefer based on some input from the user. TODO: Figure out the right order of if-clauses to use below, and outline it in comments in the code.
