    ...
    function(config,model,Mustache,template,MapView,SearchView,CongregationsView){
        ...
        return Backbone.View.extend({
            ...
            render: function(){
                ...
                this.map_view = new MapView({ el: $("#map"), collection:this.congs_coll, search_params:search_params });
                this.map_view.render()
                
                // Render the search form view
                this.search_view = new SearchView({ el: $("#search_container"), collection:this.congs_coll, model:search_params });
